    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          {/* Course Header */}
          <div className="mb-8">
            <h1 className="text-2xl font-bold mb-4 font-gilory">VUE JS SCRATCH COURSE</h1>
            <div className="flex items-center gap-4 mb-4">
              <div className="flex items-center gap-2">
                <Avatar className="h-8 w-8">
                  <AvatarImage src="@/public/avatars/avatar1.png" alt="Yacine Bensidahmed" />
                  <AvatarFallback>YB</AvatarFallback>
                </Avatar>
                <div className="flex flex-col items-start">
                  <span className="text-sm font-medium text-[#3DCBB1]">Yacine Bensidahmed</span>
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500 font-normal">
              ...
              Applications when used in combination with modern tooling and supporting libraries.
            </p>
          </div>
              ...
              <CardContent className="pt-6">
                <div className="mb-4">
                  <div className="flex items-center justify-start mb-2">
                    <span className="text-2xl font-bold">US$22.40</span>
                    <span className="text-gray-500 line-through ml-2 font-semibold text-gray">$28.13</span>
                  </div>
                  <Badge variant="secondary" className="text-white text-md font-gilroy font-semibold rounded-[2px] bg-[#A04AE3] px-2">20% OFF</Badge>
                </div>
                <div className="space-y-4">
                  <Button className="w-full bg-[#3DCBB1] rounded-xl text-white hoverTransition hover:bg-[#3DCB11]" size="lg" onClick={handleBuyClick}>
                    Buy
                  </Button>
                  <Button variant="outline" className="w-full hoverTransition rounded-xl" size="lg" onClick={handleFavorite}>
                    {favorite ? (
                      <>
                ...
                <div className="grid grid-row-2 md:grid-row-4 gap-2 mt-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm text-muted-foreground">152 Lectures</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <Image src={screen} alt="screen" width="20px" height="20px" />
                    <p className="text-sm text-muted-foreground">21h 33m total lenghts</p>
                  </div>
                  <div className="flex items-center gap-2">
